...
#### <ins>Warp Shuffle</ins>
 [![Warp Shuffle](https://img.shields.io/badge/Warp%20Shuffle-Slides-white.svg)](https://people.maths.ox.ac.uk/gilesm/cuda/lecs/lec4.pdf)
...
| 7c | [Reduce Sum with Complete Unroll](https://github.com/Logeswaran123/CUDA-Programming/tree/main/7_reduction_loop_warp_complete/reduction_complete_unroll) | Perform reduction sum operation with completely unrolled loop and using Shared Memory in GPU kernel. |
